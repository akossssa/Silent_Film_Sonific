{
    "patcher": {
        ...
        "enablevscroll": 1,
        "devicewidth": 0.0,
        "description": "Automated self-test harness for Layer A basic motion analysis",
        "digest": "",
        "tags": "sfs,test,video,analysis",
        "style": "",
        "subpatcher_template": "",
        ...
        "boxes": [
            {
                "box": {
                    "id": "obj-1",
                    "maxclass": "comment",
                    "text": "Layer A Automated Self-Test",
            ...
            },
            {
                "box": {
                    "id": "obj-5",
                    "maxclass": "newobj",
                    "text": "js sfs.video_analysis.basic_motion.selftest_driver.js",
                    "patching_rect": [170.0, 155.0, 330.0, 22.0]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    "id": "obj-7",
                    "maxclass": "newobj",
                    "text": "print sfs.layer_a.selftest",
                    "patching_rect": [520.0, 155.0, 170.0, 22.0]
                }
            },
            {
                "box": {
                    "id": "obj-8",
                    "maxclass": "comment",
                    "text": "Report: logs/tests/layer_a_selftest.latest.json",
            ...
            },
            {
                "box": {
                    "id": "obj-9",
                    "maxclass": "comment",
                    "text": "Append log: logs/tests/layer_a_selftest.jsonl",
